...
public class HorseRaceExam {
	...
	public static List<HorseRace> horseList;

	public static void main(String[] args) {
		
		// 고정된 크기의 리스트 객체 생성하기
		horseList = Arrays.asList(new HorseRace("01번말"), new HorseRace("02번말"), new HorseRace("03번말"), new HorseRace("04번말"),
				new HorseRace("05번말"), new HorseRace("06번말"), new HorseRace("07번말"), new HorseRace("08번말"), new HorseRace("09번말"),
				new HorseRace("10번말"));
 ...
 * 경주마 스레드 클래스
 */
class HorseRace extends Thread implements Comparable<HorseRace> {
	...
	@Override
	public int compareTo(HorseRace o) {
	...
	public void run() {
		...
		while (true) {
			...
			for (int i = 0; i < HorseRaceExam.horseList.size(); i++) {
				...
				String horseCourse = "--------------------------------------------------"; // 50구간
				HorseRace horse = HorseRaceExam.horseList.get(i);
