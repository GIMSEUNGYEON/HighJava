...
public class T08MapTest {
	public static void main(String[] args) {
		...
		System.out.println("Interator를 이용하는 방법");
		...
		//방법2 => 향상된 for문(forEach문)이용
		System.out.println("================================================");
		System.out.println("향상된 for문(forEach문)이용");
		...
		//		  Map에서 이 Map.Entry 타입의 객체들을 Set타입으로 제공하는 메서드를 사용한다.
		
		// Map.Entry타입의 객체를 담은 Set객체 가져오기
		System.out.println("entrySet()을 이용하는 방법");
